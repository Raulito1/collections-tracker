      ...
      <main className="p-6 md:p-8 max-w-[1600px] mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-display font-bold">60-90 Days</h1>
          </div>
          <p className="text-gray-400">Invoices aged 60 to 90 days past due</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-white/10">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold mb-2">60-90 Days Bucket</h2>
