      ...
      <main className="p-6 md:p-8 max-w-[1600px] mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-display font-bold">30-60 Days</h1>
          </div>
          <p className="text-gray-400">Invoices aged 30 to 60 days past due</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-white/10">
          <div className="text-center py-12">
            ...
            <h2 className="text-xl font-semibold mb-2">30-60 Days Bucket</h2>
